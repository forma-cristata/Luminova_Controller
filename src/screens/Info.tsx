	...
	const sections = [
		...
		},
		{
			...
			data: [
				...
				"Use the color wheel to adjust hue and saturation by tapping and dragging within the circular picker.",
				"Use the brightness slider below the color wheel to adjust the brightness/value of the selected color.",
				...
				"Select colors from the palette strip that appears above the controls when dots are selected. This shows all unique colors currently used in your setting, sorted by hue.",
				"Reverse dot order in independent rows by swiping left or right across the respective 8-dot row.",
				"Copy colors from one row to another by swiping up or down from one row to another.",
				"Randomize the order of the colors using the shuffle button to the left of the setting's name.",
